...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Nov 16, 2022 16:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Hello! Today is your birthday, isn't it? I just wanna say", " ", "<b>Happy birthday, Elvina Vania!</b>", " ", "I hope everything you wish for this year comes true. Keep being a good person. You will be a successful person in the future, I'm sure. Please keep yourself sane. It might be many problems will come, but I'm sure you already know how to deal with them.", " ","One more thing. Tap again."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["There are some gifts that I will give you. You will know once you open it, so if it's the time, go ahead! My wish for you? It's already written on paper. So you can check it out when you receive the gifts.", " ", "I'm sorry if I can only give you this. I would be grateful if you keep using that gift; at least it's useful hehe.", " ", "Once again, happy birthday!", " ", "Aku sayang kamu!"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
